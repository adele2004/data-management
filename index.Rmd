...
Mostly this is not fun and exciting, but it is important stuff for any scientist to know. I’ll try my best to make it interesting! Hopefully by the end of the module you’ll see the value in it all - both for you as an individual and for science and society in general.
...
12. Lastly, you need to install the [_Tidyverse_](https://www.tidyverse.org/) set of R packages. This can be done running the code `install.packages("tidyverse")` in your console.
